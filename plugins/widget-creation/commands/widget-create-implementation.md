---
description: "Create a Page Builder widget following the instructions file generated by the research stage."
argument-hint: "instructionsFilePath"
allowed-tools: Bash, Glob, Grep, Read, Edit, Write, TodoWrite, BashOutput, mcp__kentico.docs.mcp__*
---
...
- **Instructions File Path:** `$ARGUMENTS` - The path to the file that contains instructions on how to create the widget. You must follow these during implementation.
