---
description: "Migrate a page and its business/presentation logic from KX13 to an XbyK project."
...
- You can use the /kentico-kx13-migration:migrate-page-visual prompt to fix visual issues caused by the migration.

The page migration is now complete. Continue migrating other pages by repeatedly running /kentico-kx13-migration:migrate-page-widgets and /kentico-kx13-migration:migrate-page. To migrate shared components such as layouts, headers, footers, use /kentico-kx13-migration:migrate-shared-component.
```
