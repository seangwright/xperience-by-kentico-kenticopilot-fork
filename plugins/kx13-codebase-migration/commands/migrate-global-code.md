---
description: "Migrate global code from KX13 to an XbyK project."
allowed-tools: Bash, Glob, Grep, Read, Edit, Write, TodoWrite, WebFetch, WebSearch, BashOutput, mcp__kentico.docs.mcp__*
---
...
- Continue with the /kentico-kx13-migration:migrate-page-widgets prompt to migrate Page Builder widgets used by the specified page.
```
