---
description: "Ensure a migrated page visually matches its original KX13 page using Playwright."
...
Provide all three parameters separated by spaces or new lines:
...
- Continue migrating other pages by repeatedly running /kentico-kx13-migration:migrate-page-widgets and /kentico-kx13-migration:migrate-page.
```
