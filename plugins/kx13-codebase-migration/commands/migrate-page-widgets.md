---
description: "Migrate Page Builder widgets and sections used by a specific page from KX13 to an XbyK project."
...
- Continue with the /kentico-kx13-migration:migrate-page prompt to migrate individual pages.
```
