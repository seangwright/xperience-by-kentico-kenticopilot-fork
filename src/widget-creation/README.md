...
Copy the appropriate files for your AI assistant. Note that the files also add the Xperience by Kentico [Documentation MCP server](https://docs.kentico.com/x/mcp_server_xp) to your workspace via the `mcp.json` file.

> **Important:** For Claude Code, you need to add the server manually via the command line. Follow the [setup instructions](src/widget-creation/claude-code/MCP_Setup.md).
...
In the prompt, provide the path to your requirements file. Include all supplementary materials and required context, such as project-specific instructions.
...
In the prompt, provide the path to the instructions file generated by the research stage, as well as any supplementary, project-specific instructions.
